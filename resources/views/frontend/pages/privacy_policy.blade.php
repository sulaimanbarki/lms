...
<div class="container my-5">
    <h3 class="fw-bold">Privacy Policy for ijazkhan@gmail.com</h3 class="fw-bold">

    <p>At hosdf df , accessible from http://horizonext.in/, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by hosdf df and how we use it.
    </p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
        the information that they shared and/or collect in hosdf df . This policy is not applicable to any information
        collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a
            href="https://www.termsfeed.com/privacy-policy-generator/">TermsFeed Free Privacy Policy Generator</a>.</p>

    <h3 class="fw-bold" >Consent</h3>

    <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

    <h3 class="fw-bold">Information we collect</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">How we use your information</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">Log Files</h3 class="fw-bold">

    <p>hosdf df follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <h3 class="fw-bold">Cookies and Web Beacons</h3 class="fw-bold">

    <p>Like any other website, hosdf df uses 'cookies'. These cookies are used to store information including visitors'
    ...
    <h3 class="fw-bold">Google DoubleClick DART Cookie</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">Our Advertising Partners</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">Advertising Partners Privacy Policies</h3 class="fw-bold">

    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of hosdf df .</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on hosdf df , which are sent directly to users' browser. They
    ...
    <p>Note that hosdf df has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h3 class="fw-bold">Third Party Privacy Policies</h3 class="fw-bold">

    <p>hosdf df 's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
    ...
    <h3 class="fw-bold">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">GDPR Data Protection Rights</h3 class="fw-bold">
    ...
    <h3 class="fw-bold">Children's Information</h3 class="fw-bold">
    ...
    <p>hosdf df does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
