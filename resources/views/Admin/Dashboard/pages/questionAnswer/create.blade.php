...
<div class="container my-3">
    ...
    <form action="{{route('questions.store')}}" class="my-2 mt-3" method="POST">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <select onchange="fetchSubjects(this.value)" class="form-select" name="department_id" aria-label="Default select example">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="answer" placeholder="Enter answer" value="{{ old('answer') }}" rows="3"></textarea>
                </div>
                <!-- show error message -->
                @error('answer')
                <p class="text-danger -500 text-xs fst-italic">{{ $message }}</p>
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full px-3">
                <button class="btn btn-primary bg-blue-500 hover:bg-blue-700 mt-3 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                    Create
                </button>
            </div>
        </div>
...
<!-- End edit Question Answers section  -->
